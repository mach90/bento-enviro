...
const cardLocationContainerStyle = "p-4 flex flex-col md:flex-row gap-4 justify-between bg-cardFourth rounded-lg shadow-md col-span-1 row-span-1 lg:col-span-3 xl:col-span-2";
const cardLocationInfosContainerStyle = "flex flex-col w-full";
const cardLocationCityStyle = "font-heading font-black text-lg border-b-2 border-borderFourth text-textFourth flex flex-row gap-1 justify-start items-center";
const cardLocationDateStyle = "font-body mt-1 text-sm text-textFourthVariant";
