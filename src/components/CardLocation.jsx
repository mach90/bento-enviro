...
const cardLocationContainerStyle = "p-2 flex flex-col md:flex-row gap-2 justify-between bg-second col-span-full xl:col-span-3 w-full h-full";
...
const cardLocationDateStyle = "bg-fourth font-body mt-1 text-body text-1000 w-max";
