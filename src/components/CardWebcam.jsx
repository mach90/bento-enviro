...
export default function CardWebcam() {
    ...
    return (
        <div className=" flex flex-row gap-4 overflow-x-scroll md:col-span-2 lg:col-span-1">
            {!webcams && <p className="font-custom2 text-xl text-stone-200">No webcams found</p>}
