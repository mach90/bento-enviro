...
export default function CardLogo() {
    return (
        <div className="bg-gradient-to-br from-colorAccent1t via-colorAccent2t to-colorAccent3t flex flex-col col-span-full lg:col-span-1 justify-center items-start p-4 border border-colorBorder">
